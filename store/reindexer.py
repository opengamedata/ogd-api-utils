...
def meta_to_index(meta:Dict, data_dir:Path):
    ...
    return {
        ...
        "population_template" : meta.get("population_template", None),
        "players_template"    : meta.get("players_template", None),
        "sessions_template"   : meta.get("sessions_template", None),
        "events_template"     : meta.get("vents_template", None),
