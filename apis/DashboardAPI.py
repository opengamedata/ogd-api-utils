...
class DashboardAPI:
    ...
    def register(app:Flask):
        ...
        api.add_resource(DashboardAPI.SessionList, '/game/<game_id>/players/')
        api.add_resource(DashboardAPI.Sessions, '/game/<game_id>/players/metrics')
        api.add_resource(DashboardAPI.Session, '/game/<game_id>/player/<player_id>/metrics')
