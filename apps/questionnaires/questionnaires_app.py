...
try:
    from apis.QuestionnaireAPI import QuestionnaireAPI
except ImportError as err:
    _logImportErr(msg="Could not import Questionnaire API:", err=err)
except Exception as err:
    _logImportErr(msg="Could not import Questionnaire API, general error:", err=err)
else:
    QuestionnaireAPI.register(application)
